...
class Factory
{
	...
	public  function getPdo()
	{
		return new \PDO
		(
		"mysql:host=mariadb;dbname=discussIt;charset=utf8",
	...
	{
		return new \paeschu\Service\Login\LoginPdoService
		(
			$this->getPdo()
		);
	}
	...
	{
		return  new \paeschu\Controller\LoginController
		(
			$this->getTemplateEngine(), $this->getLoginService()
		);
	}
